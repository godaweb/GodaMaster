...
namespace db_test {
    ...
    public class 出荷可能一覧表CrystalReport : ReportClass {
        
        public 出荷可能一覧表CrystalReport() {
        }
        
        public override string ResourceName {
            get {
                return "出荷可能一覧表CrystalReport.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "db_test.出荷可能一覧表CrystalReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached出荷可能一覧表CrystalReport : Component, ICachedReport {
        
        public Cached出荷可能一覧表CrystalReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            出荷可能一覧表CrystalReport rpt = new 出荷可能一覧表CrystalReport();
            rpt.Site = this.Site;
            return rpt;
        }
