...
namespace db_test
{
    public partial class 発注残集計Form : Form
    {
        public 発注残集計Form()
        {
            InitializeComponent();
        ...
        private void 発注残集計Form_Load(object sender, EventArgs e)
        {
            this.gcMultiRow1.Template = new 発注残集計Template();
            ...
            gcMultiRow1.ColumnHeaders[0].Cells["仕入先checkBoxCell"].Value = 0;
        ...
        void gcMultiRow1_CellEditedFormattedValueChanged(object sender, CellEditedFormattedValueChangedEventArgs e)
        {
            ...
            発注残集計_商品Form fsSyohin;
            発注残集計_仕入先Form fsSirsaki;
            発注残集計_担当者Form fsTantosya;
            switch (e.CellName)
            {
                case "商品checkBoxCell":
                    ...
                    break;
                case "仕入先checkBoxCell":
                    currentCell = gcMultiRow1.ColumnHeaders[0].Cells["仕入先checkBoxCell"];
                    checkBoxCell1 = currentCell as CheckBoxCell;
                    if ((bool)checkBoxCell1.EditedFormattedValue)
                    {
                        fsSirsaki = new 発注残集計_仕入先Form();
