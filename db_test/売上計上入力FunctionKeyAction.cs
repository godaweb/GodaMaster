...
namespace db_test
{
    class 売上計上入力FunctionKeyAction : IAction
    {
        private Keys m_KeyCode = Keys.None;

        public 売上計上入力FunctionKeyAction(Keys keyCode)
        {
        ...
        {
            get { return "売上計上入力FunctionKeyAction"; }
        }

        public void Execute(GcMultiRow target)
        {
            売上計上入力Form form = (売上計上入力Form)target.Parent;
