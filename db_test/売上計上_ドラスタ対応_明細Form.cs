...
namespace db_test
{
    public partial class 売上計上_ドラスタ対応_明細Form : Form
    {
        private string sendドラスタ_明細_Data = null;
        private string receiveドラスタ_明細_Data = null;
        private string arr = null;

        public 売上計上_ドラスタ対応_明細Form()
        {
            InitializeComponent();
        }

        private void 売上計上_ドラスタ対応_明細Form_Load(object sender, EventArgs e)
        {

            this.gcMultiRow1.Template = new 売上計上_ドラスタ対応_明細Template();
