...
namespace db_test
{
    public partial class 受注残集計_商品別内訳Form : Form
    {
        private string receiveDataSyohin = "";

        public 受注残集計_商品別内訳Form()
        {
            InitializeComponent();
        }
        ...
        public string ReceiveDataSyohin
        {
            set
            {
                ...
                this.gcMultiRow1.ColumnHeaders[0].Cells["商品コードtextBoxCell"].Value = receiveDataSyohin.ToString();
                SendKeys.Send("{ENTER}");
            }
            get
            {
        ...
        private void 受注残集計_商品別内訳Form_Load(object sender, System.EventArgs e)
        {
        ...
        private int createData()
        {
            ...
            // ストアド プロシージャ名を指定
            command.CommandText = "受注残集計_商品別内訳"; 
            ...
            if ((String)gcMultiRow1.ColumnHeaders[0].Cells["商品コードtextBoxCell"].Value != null && (String)gcMultiRow1.ColumnHeaders[0].Cells["商品コードtextBoxCell"].Value != "*")
            {
                command.Parameters.AddWithValue("@商品コード", (String)gcMultiRow1.ColumnHeaders[0].Cells["商品コードtextBoxCell"].Value);
            }
            else
            {
