...
namespace db_test
{
    class 出荷指示一覧表FunctionKeyAction : IAction
    {
        private Keys m_KeyCode = Keys.None;

        public 出荷指示一覧表FunctionKeyAction(Keys keyCode)
        {
        ...
        {
            get { return "出荷指示一覧表FunctionKeyAction"; }
        }
        ...
        public void Execute(GcMultiRow target)
        {
            ...
            出荷指示一覧表Form form = (出荷指示一覧表Form)target.Parent;
