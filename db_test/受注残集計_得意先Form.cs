...
namespace db_test
{
    public partial class 受注残集計_得意先Form : Form
    {

        private string receiveDataToksaki = "";

        public 受注残集計_得意先Form()
        {
            InitializeComponent();
        }

        private void 受注残集計_得意先Form_Load(object sender, EventArgs e)
        {
            this.gcMultiRow1.Template = new 受注残集計_得意先Template();
                ...
                case Keys.Enter:
                    ...
                    foreach (Cell cell in this.gcMultiRow1.SelectedCells)
                    {
                        if (cell.RowIndex >= 0)
                        {
                            ...
                            if (Val != null)
                            {
                                受注残集計_得意先内訳Form fm = new 受注残集計_得意先内訳Form();
                                fm.Owner = this;
        ...
        private int createData()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    gcMultiRow1.CurrentCellPosition = new GrapeCity.Win.MultiRow.CellPosition(0, "得意先コード");
                }
            }
            return 0;
        }
