...
namespace db_test
{
    public partial class 受注入力_ドラスタ対応_ヘッダForm : Form
    {
        private string sendドラスタ_ヘッダ_Data = null;
        private string receiveドラスタ_ヘッダ_Data = null;
        private string[] arr = null;
        
        public 受注入力_ドラスタ対応_ヘッダForm()
        {
            InitializeComponent();
        }

        private void 受注入力_ドラスタ対応_ヘッダForm_Load(object sender, EventArgs e)
        {
            this.gcMultiRow1.Template = new 受注入力_ドラスタ対応_ヘッダTemplate();
