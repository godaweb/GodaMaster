...
namespace db_test
{
    public partial class 売上計上明細参照Form : Form
    {
        int rowcnt = 0;
        int cancelFlag = 0;
        int idoFlag = 0;
        ...
        private void 売上計上明細参照Form_Load(object sender, EventArgs e)
        {
            this.gcMultiRow1.Template = new 売上計上明細参照Template();
            ...
            this.gcMultiRow1.ShortcutKeyManager.Register(new 売上計上明細参照FunctionKeyAction(Keys.F4), Keys.F4);
            this.gcMultiRow1.ShortcutKeyManager.Register(new 売上計上明細参照FunctionKeyAction(Keys.F5), Keys.F5);
            this.gcMultiRow1.ShortcutKeyManager.Register(new 売上計上明細参照FunctionKeyAction(Keys.F9), Keys.F9);
            this.gcMultiRow1.ShortcutKeyManager.Register(new 売上計上明細参照FunctionKeyAction(Keys.F10), Keys.F10);
        ...
        void gcMultiRow1_CellValidated(object sender, CellEventArgs e)
        {
            ...
            switch (e.CellName)
            {
                ...
                case "受注番号始gcTextBoxCell":
                    ...
                    {
                        henkanFlag = 0;
                        if (gcMultiRow1.ColumnHeaders[0].Cells["受注番号始gcTextBoxCell"].Value != null)
                        {
                            gcMultiRow1.ColumnHeaders[0].Cells["日付始textBoxCell"].Value = gcMultiRow1.ColumnHeaders[0].Cells["受注番号始gcTextBoxCell"].Value;
                        }    
                        gcMultiRow1.ColumnHeaders[0].Cells["受注番号始gcTextBoxCell"].Value = null;
                        return;
                    }
                    break;
                case "受注番号終gcTextBoxCell":
        ...
        private int execProcedure()
        {
            ...
            //gcMultiRow1.CurrentCellPosition = new GrapeCity.Win.MultiRow.CellPosition(GrapeCity.Win.MultiRow.CellScope.Row, 0, 0);
        }
            ...
            switch (keyCode)
            {
                case Keys.F4:
                    ...
                    if (createReportData() == 0)
                    {
                        ...
                        プレビューform.dataSet = dataSet;
                        プレビューform.rptName = "売上計上明細参照リストCrystalReport";
                        プレビューform.Show();
                    }
                    else
                    {
                ...
                case Keys.F9:
                    ...
                    try
                    {
                        if (gcMultiRow1.RowCount == 0) break;
        ...
        //            if (e.MoveStatus == MoveStatus.MoveDown)
        //            {
        //                e.NewCellPosition = new CellPosition(CellScope.ColumnHeader, 0, "受注番号始gcTextBoxCell");
        //            }
        //            else if (e.MoveStatus == MoveStatus.MoveUp)
        //            {
        //                e.NewCellPosition = new CellPosition(CellScope.ColumnHeader, 0, "日付始textBoxCell");
        ...
        //            if (e.MoveStatus == MoveStatus.MoveDown)
        //            {
        //                e.NewCellPosition = new CellPosition(CellScope.ColumnHeader, 0, "受注番号終gcTextBoxCell");
        //            }
        //            else if (e.MoveStatus == MoveStatus.MoveUp)
        //            {
        //                e.NewCellPosition = new CellPosition(CellScope.ColumnHeader, 0, "日付終textBoxCell");
