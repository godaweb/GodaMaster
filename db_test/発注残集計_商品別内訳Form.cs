...
namespace db_test
{
    public partial class 発注残集計_商品別内訳Form : Form
    {
        private string receiveDataSyohin = "";

        public 発注残集計_商品別内訳Form()
        {
            InitializeComponent();
        }
        ...
        private void 発注残集計_商品別内訳Form_Load(object sender, EventArgs e)
        {
        ...
        private int createData()
        {
            ...
            // ストアド プロシージャ名を指定
            command.CommandText = "発注残集計_商品別内訳";
