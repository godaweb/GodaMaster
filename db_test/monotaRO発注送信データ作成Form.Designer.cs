namespace db_test
{
    partial class monotaRO発注送信データ作成Form
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.monotaRO発注送信データ作成Template1 = new db_test.monotaRO発注送信データ作成Template();
            ...
            this.gcMultiRow1.Size = new System.Drawing.Size(628, 472);
            this.gcMultiRow1.TabIndex = 0;
            this.gcMultiRow1.Template = this.monotaRO発注送信データ作成Template1;
            ...
            this.Name = "monotaRO発注送信データ作成Form";
            this.Text = "monotaRO発注送信データ作成Form";
        ...
        private monotaRO発注送信データ作成Template monotaRO発注送信データ作成Template1;
