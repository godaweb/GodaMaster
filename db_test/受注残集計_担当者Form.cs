...
namespace db_test
{
    public partial class 受注残集計_担当者Form : Form
    {
        private string receiveDataTantosya = "";

        public 受注残集計_担当者Form()
        {
            InitializeComponent();
        }

        private void 受注残集計_担当者Form_Load(object sender, EventArgs e)
        {
                ...
                case Keys.Enter:
                    ...
                    foreach (Cell cell in this.gcMultiRow1.SelectedCells)
                    {
                        if (cell.RowIndex >= 0)
                        {
                            ...
                            if (Val != null)
                            {
                                受注残集計_担当者内訳Form fm = new 受注残集計_担当者内訳Form();
                                fm.Owner = this;
        ...
        private int createData()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    gcMultiRow1.CurrentCellPosition = new GrapeCity.Win.MultiRow.CellPosition(0, "担当者コード");
                }
            }
            return 0;
        }
