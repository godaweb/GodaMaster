namespace db_test
{
    partial class オンライン発注リストForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.オンライン発注リストTemplate1 = new db_test.オンライン発注リストTemplate();
            ...
            this.gcMultiRow1.Template = this.オンライン発注リストTemplate1;
            ...
            this.Name = "オンライン発注リストForm";
            this.Text = "オンライン発注リストForm";
            this.Load += new System.EventHandler(this.オンライン発注リストForm_Load);
        ...
        private オンライン発注リストTemplate オンライン発注リストTemplate1;
