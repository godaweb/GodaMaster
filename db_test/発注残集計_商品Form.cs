...
namespace db_test
{
    public partial class 発注残集計_商品Form : Form
    {
        ...
        private void 発注残集計_商品Form_Load(object sender, EventArgs e)
        {
                ...
                case Keys.Enter:
                    ...
                    foreach (Cell cell in this.gcMultiRow1.SelectedCells)
                    {
                        if (cell.RowIndex >= 0)
                        {
                            ...
                            if (Val != null)
                            {
                                発注残集計_商品別内訳Form fm = new 発注残集計_商品別内訳Form();
                                fm.Owner = this;
        ...
        private int createData()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("データがありません", "発注残集計");
                    gcMultiRow1.Select();
